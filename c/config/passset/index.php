  ...
  <body>
    ...
    <nav id = "home" style="height: 72px;"class="light-blue darken-4">
      <div class = "nav-wrapper">
        ...
        <h1 style="font-size: 30px;font-family: Handlee; margin-top: 15px;"class="brand-logo center">Change Password</h1>
    ...
    <h1 class="center" style="font-family: Satisfy; color: #01579b;">change your password</h1>
    <div class="container">
      <div class="row">
