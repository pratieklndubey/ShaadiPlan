...
::placeholder{
  ...
  <body>
    ...
    <h1 class="center" style="font-family: Satisfy; color: #01579b;">Pricing</h1>
    <div class="container">
      <div class="row">
        <div class="col s8 offset-s2">
          <div class="card-panel grey lighten-4 z-depth-2" style="height: 450px;">
            <form  action="pricing.php" method="POST">
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                <input name="price" type="number" placeholder = "Starting Price (per Day/Individual)" class="validate" required="" aria-required="true">
              </div>
              <p style="margin-top:-5px; margin-left:150px;">Provide the percentage distribution of the payment</p>
              <div class="row" style="margin-top: -5px; width: 50%;margin-left:150px;">
                <div class="input-field col s4 center" >
                  <input name = "booking" type="number" placeholder = "Booking" class="validate" required="" aria-required="true">
                </div>
                <div class="input-field col s4 center" >
                  <input name = "event" type="number" placeholder = "Event" class="validate" required="" aria-required="true">
                </div>
                <div class="input-field col s4 center" >
                  <input name = "delivery" type="number" placeholder = "Delivery" class="validate" required="" aria-required="true">
                </div>
              </div>
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                <select name="travel">
                  <option value="" disabled selected>Can you travel outside the city</option>
                  <option value="1">Yes</option>
                  <option value="0">No</option>
                </select>
              </div>
              <div class="input-field" style="width: 500px; margin-left: 50px;margin-top: -5px;">
                <textarea data-length="140" maxlength="140" style="resize: none;" class="materialize-textarea validate" name="cancel" required="" aria-required="true" placeholder="Cancellation Policy"></textarea>
              </div>
