...
::placeholder{
  ...
  <body>
    ...
    <h1 class="center" style="font-family: Satisfy; color: #01579b;">Tell us about your business experience</h1>
    <div class="container">
      <div class="row">
        <div class="col s8 offset-s2">
          <div class="card-panel grey lighten-4 z-depth-2" style="height: 340px;">
            <form  action="abstract.php" method="POST">
              <div class="input-field" style="width: 500px; margin-left: 50px;margin-top: -5px;">
                <textarea data-length="140" maxlength="140" style="resize: none;" class="materialize-textarea validate" name="intro" required="" aria-required="true" placeholder="About your business"></textarea>
              </div>
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                <input name="projects" type="number" placeholder = "How many weddings you have covered?" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field browser-default" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                <input name="experience" type="date" placeholder = "Since when you are working" class="datepicker" required="" aria-required="true">
              </div>
