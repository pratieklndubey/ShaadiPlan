...
::placeholder{
  ...
  <body>
    ...
    <h1 class="center" style="font-family: Satisfy; color: #01579b;">make us your acquaintanc</h1>
    <div class="container">
      <div class="row">
          ...
          <div class="card-panel grey lighten-4 z-depth-2" style="height: 340px;">
            <form  action="setup.php" method="POST">
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                <input name="owner" type="text" placeholder = "Owner's Name" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field autocomplete" style="width:300px; margin-left: 150px;margin-top: -5px;">
                <input id = "location" type="text" name="city" placeholder="City" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field autocomplete" style="width:300px; margin-left: 150px; margin-top: -5px;">
                <input id = "service" type="text" name="category" placeholder="Category" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
    ...
    var services = ["Photography","Videography","Choreography","Catering","Invitation","Decorators","Mehendi","Venue"];
