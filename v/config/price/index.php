      ...
      <div class="row">
        <div class="col s3 ">
          <ul class="collection with-header">
            ...
            <a class="collection-item white-text light-blue darken-4" style="font-family: Gloria Hallelujah;">Price<div class="secondary-content"><i class="material-icons white-text">monetization_on</i></div></a>
              ...
              <form  action="abstract.php" method="POST">
                <div class="row">
                  <div class="input-field col s6 offset-s3 center" style="width: 50%; margin-top:-3px;">
                    <input id="price"name = "price" type="number" <?php echo "value = ".$_SESSION['price'];?> >
                    <label for="price">Price</label>
                  </div>
                  <div class="input-field col s6 offset-s3 center" style="width: 50%; margin-top:-3px;">
                    <input id="booking"name="booking" type="number" <?php echo "value = ".$_SESSION['booking'];?>>
                    <label for="booking">Booking</label>
                  </div>
                  <div class="input-field col s6 offset-s3 center" style="width: 50%; margin-top:-3px;">
                    <input id="event"name="event" type="number" <?php echo "value = ".$_SESSION['event'];?>>
                    <label for="event">Event</label>
                  </div>
                  <div class="input-field col s6 offset-s3 center" style="width: 50%; margin-top:-3px;">
                    <input id="delivery"name="delivery" type="number" <?php echo "value = ".$_SESSION['delivery'];?>>
                    <label for="event">Delivery</label>
                  </div>
