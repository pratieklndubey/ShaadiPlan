      ...
      <div class="row">
        <div class="col s3 ">
          <ul class="collection with-header">
            ...
            <a class="collection-item white-text light-blue darken-4" style="font-family: Gloria Hallelujah;">Contact<div class="secondary-content"><i class="material-icons white-text">contact_phone</i></div></a>
              ...
              <form  action="contact.php" method="POST">
                <div class="row">
                  <div class="input-field col s6 offset-s3 center" style="width: 50%; margin-top:-3px;">
                    <input id="phone"name = "phone" type="tel" <?php echo "value = ".$_SESSION['phone'];?> >
                    <label for="phone">Phone</label>
                  </div>
                  <div class="input-field col s6 offset-s3 center" style="width: 50%; margin-top:-3px;">
                    <input id="pincode"name="pincode" type="text" <?php echo "value = ".$_SESSION['pincode'];?>>
                    <label for="pincode">Pincode</label>
                  </div>
                  <div class="input-field col s3 offset-s3 center" style="width: 25%; margin-top:-3px;">
                    <input id="url"name="url" type="text" <?php echo "value = ".$_SESSION['url'];?>>
                    <label for="url">url</label>
                  </div>
                  <div class="input-field col s3 center" style="width: 25%; margin-top:-3px;">
                    <input id="facebook"name="facebook" type="text" <?php echo "value = ".$_SESSION['facebook'];?>>
                    <label for="facebook">Facebook</label>
                  </div>
                  <div class="input-field col s10 offset-s1" style="margin-top:-3px;">
                    <textarea id="address" data-length="140" maxlength="140" style="resize: none;" class="materialize-textarea " name="address"><?php echo $_SESSION['address']?></textarea>
