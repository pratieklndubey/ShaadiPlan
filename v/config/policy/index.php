      ...
      <div class="row">
        <div class="col s3 ">
          <ul class="collection with-header">
            ...
            <a class="collection-item white-text light-blue darken-4" style="font-family: Gloria Hallelujah;">Policy<div class="secondary-content"><i class="material-icons white-text">assignment</i></div></a>
              ...
              <form  action="abstract.php" method="POST">
                <div class="row">
                  <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                    <select id="travel"name="travel" <?php echo "value = ".$_SESSION['travel'];?>>
                      <option value="" disabled>Can you travel outside the city</option>
                      <?php
                      if($_SESSION['travel'] == 'Yes')
                      {
                  ...
                  <div class="input-field col s10 offset-s1" style="margin-top:-3px;">
                    <textarea data-length="140" maxlength="140" style="resize: none;" class="materialize-textarea " name="intro" placeholder="Write a your new cancellation policy."</a></textarea>
                  </div>
