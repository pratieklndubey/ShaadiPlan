  ...
  <body>
    ...
    <nav id = "home" style="height: 72px;"class="light-blue darken-4">
      <div class = "nav-wrapper">
        <a style="font-family: 'Indie Flower', cursive; font-size: 45px; margin-left: 40px;"href="../../dashboard">ShaadiPlan<img style=" margin-top:2px;margin-left:5px; width: 40px;" src="../../../image/icon.png"></a>
    ...
    <div class="container" style="width: 90%; height: 448px;">
      <div class="row">
        <div class="col s3 ">
          <ul class="collection with-header">
            ...
            <a class="collection-item white-text light-blue darken-4" style="font-family: Gloria Hallelujah;">Password<div class="secondary-content"><i class="material-icons white-text">lock</i></div></a>
        ...
        <div class="col s8 offset-s1">
          <div class="col s10">
            <div class="card-panel grey lighten-4 z-depth-2" style="height: 300px;">
              <form  action="passset.php" method="POST">
                <div class="input-field" style="width: 300px; margin-left: 150px;">
                  <input name = "cpin" type="password" placeholder = "Current Password" class="validate" required="" aria-required="true">
                </div>
                <div class="input-field" style="width: 300px; margin-left: 150px;">
                  <input name = "pin" type="password" placeholder = "New Password" class="validate" required="" aria-required="true">
                </div>
