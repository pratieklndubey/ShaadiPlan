  ...
  <body>
    <nav id = "home" style="height: 72px;"class="light-blue darken-4">
      <div class = "nav-wrapper">
        ...
        <h1 style="font-size: 30px;font-family: Handlee; margin-top: 15px;"class="brand-logo center">Administrator</h1>
      </div>
    </nav>
    <h1 class="center" style="font-family: Satisfy; color: #01579b;">Login to the dministrator account</h1>
    <div class="container">
      <div class="row">
          ...
          <div class="card-panel grey lighten-4 z-depth-2" style="height: 320px;">
            <form  action="admin.php" method="POST" enctype="multipart/form-data">
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
                <input name="id" type="text" placeholder = "Username" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field" style="width: 300px; margin-left: 150px;margin-top: -5px;">
